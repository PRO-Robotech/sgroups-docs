...
<div className="arch-legend">
  ...
  <span><span className="arch-legend__dot arch-legend__dot--cp"></span>Ресурсы связи</span>
  <span><span className="arch-legend__dot arch-legend__dot--client"></span>Ресурсы абстракции</span>
  <span><span className="arch-legend__dot arch-legend__dot--agent"></span>Правила доступа</span>
</div>
