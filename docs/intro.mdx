...
<ArchSvg
  ...
  nodes={[
    { id: 'ns',   col: 2, row: 0, kind: 'store',  title: 'Namespace',    subtitle: 'область имён' },
    { id: 'host', col: 0, row: 1, kind: 'client', title: 'Host' },
    { id: 'hb',   col: 1, row: 1, kind: 'cp',     title: 'HostBinding' },
    { id: 'ag',   col: 2, row: 1, kind: 'cp',     title: 'AddressGroup' },
    { id: 'sb',   col: 3, row: 1, kind: 'cp',     title: 'ServiceBinding' },
    { id: 'svc',  col: 4, row: 1, kind: 'client', title: 'Service' },
    { id: 'net',  col: 0, row: 2, kind: 'client', title: 'Network' },
    { id: 'nb',   col: 1, row: 2, kind: 'cp',     title: 'NetworkBinding' },
    { id: 'rule', col: 2, row: 3, kind: 'agent',  title: 'Rule' },
  ]}
  edges={[
    { from: 'ns',   to: 'ag',   label: 'содержит ресурсы' },
    { from: 'host', to: 'hb',   label: '1:N', bidir: true },
    { from: 'hb',   to: 'ag' },
    { from: 'ag',   to: 'sb' },
    { from: 'sb',   to: 'svc',  label: '1:N', bidir: true },
    { from: 'net',  to: 'nb',   label: '1:N', bidir: true },
    { from: 'nb',   to: 'ag',                       routing: 'h-v' },
    { from: 'rule', to: 'ag',   label: 'endpoint',  lane: -1 },
    { from: 'rule', to: 'svc',  label: 'endpoint',  routing: 'v-h', lane: 2 },
  ]}
/>
