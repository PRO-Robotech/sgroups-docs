...
<ArchGraph
  ...
  nodes={[
    { id: 'ns',   kind: 'store',  title: 'Namespace',     subtitle: 'область имён', x: 540, y: 70,  fixed: true },
    { id: 'ag',   kind: 'cp',     title: 'AddressGroup',  subtitle: 'центральная сущность', x: 540, y: 360, fixed: true },
    { id: 'host', kind: 'client', title: 'Host',          x: 110, y: 360 },
    { id: 'hb',   kind: 'cp',     title: 'HostBinding',   x: 320, y: 360 },
    { id: 'sb',   kind: 'cp',     title: 'ServiceBinding', x: 760, y: 360 },
    { id: 'svc',  kind: 'client', title: 'Service',       x: 970, y: 360 },
    { id: 'nb',   kind: 'cp',     title: 'NetworkBinding', x: 540, y: 540 },
    { id: 'net',  kind: 'client', title: 'Network',        x: 540, y: 660 },
    { id: 'rule', kind: 'agent',  title: 'Rule',           subtitle: 'политика', x: 200, y: 600 },
  ]}
  edges={[
