...
<div className="flow-diagram">
  <div className="flow-step">
    ...
    <div className="flow-step__title">cert-manager</div>
    <div className="flow-step__subtitle">Контроллер выпуска сертификатов</div>
  </div>
  <div className="flow-arrow">→</div>
  <div className="flow-step">
    <div className="flow-step__icon">📜</div>
    <div className="flow-step__title">Certificate</div>
    <div className="flow-step__subtitle">CR cert-manager.io/v1</div>
  </div>
  <div className="flow-arrow">→</div>
  <div className="flow-step">
    <div className="flow-step__icon">🔐</div>
    <div className="flow-step__title">Secret</div>
    <div className="flow-step__subtitle">tls.crt + tls.key</div>
  </div>
  <div className="flow-arrow">→</div>
  <div className="flow-step">
    <div className="flow-step__icon">📦</div>
    <div className="flow-step__title">apiserver Pod</div>
    <div className="flow-step__subtitle">монтирует Secret в /etc/sgroups/tls/</div>
  </div>
  <div className="flow-arrow">→</div>
  <div className="flow-step">
    <div className="flow-step__icon">🌐</div>
    <div className="flow-step__title">kube-apiserver</div>
    <div className="flow-step__subtitle">TLS-соединение на :8443</div>
  </div>
</div>
