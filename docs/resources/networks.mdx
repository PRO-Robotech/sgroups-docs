...
**Network** — ресурс, описывающий сетевой сегмент в формате CIDR. Сети привязываются
к AddressGroup через NetworkBinding, добавляя свой CIDR в nftables set группы.
...
Сам ресурс Network не создаёт собственных nftables-объектов. CIDR сети добавляется как
