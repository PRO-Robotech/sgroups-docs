...
**ServiceBinding** — ресурс привязки сервиса к группе адресов. Определяет, какие
транспортные конфигурации (протоколы, порты, ICMP-типы) ассоциированы с данной AddressGroup.
