...
`sg-agent` экспортирует метрики в формате Prometheus и позволяет отслеживать состояние
синхронизации, правил nftables и общую работоспособность агента.
...
Для оценки работоспособности агента рекомендуется отслеживать следующие сигналы:

<div className="health-grid">
  <div className="health-card health-card--healthy">
    <div className="health-card__title">Здоров (Healthy)</div>
    <ul className="health-card__list">
      <li>grpc_connected = 1</li>
      <li>sync_errors_total не растет</li>
      <li>sync_last_success &lt; 2 × interval</li>
      <li>nft_apply_errors = 0</li>
    </ul>
  </div>
  <div className="health-card health-card--degraded">
    <div className="health-card__title">Деградация (Degraded)</div>
    <ul className="health-card__list">
      <li>sync_errors_total растет</li>
      <li>dns_errors_total растет</li>
      <li>sync_last_success &gt; 2 × interval</li>
    </ul>
  </div>
  <div className="health-card health-card--unhealthy">
    <div className="health-card__title">Неработоспособен (Unhealthy)</div>
    <ul className="health-card__list">
      <li>grpc_connected = 0</li>
      <li>sync_last_success &gt; 5 × interval</li>
      <li>nft_apply_errors растет</li>
    </ul>
  </div>
</div>
...
:::tip
В production рекомендуется использовать формат `json` — он удобен
для разбора в системах централизованного логирования (ELK, Loki).
:::
